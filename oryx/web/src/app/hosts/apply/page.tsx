...
export const metadata: Metadata = {
  title: "Host Network Application | EVNTSZN",
  description: "Apply to join the EVNTSZN Host Network and move through the approved operator review path.",
  alternates: {
    canonical: `${getHostsOrigin()}/apply`,
  },
  openGraph: {
    title: "EVNTSZN Host Network Application",
    description: "Apply to join the EVNTSZN Host Network and move through the approved operator review path.",
