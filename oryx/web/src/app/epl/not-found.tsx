...
export default function EplNotFoundPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 text-center md:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-white/72">
          The page you tried to open is not active. Jump back into the league with the routes people actually use on game week.
        </p>
