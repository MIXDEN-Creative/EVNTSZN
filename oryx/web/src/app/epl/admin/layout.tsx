  ...
  const navSections = [
    ...
    },
    {
      ...
      links: [
        ...
        canManageAdmins ? { href: `${getAdminOrigin(host)}/pulse`, label: "Pulse" } : null,
        canManageAdmins ? { href: `${getAdminOrigin(host)}/messages`, label: "Messaging" } : null,
        canManageAdmins ? { href: `${getAdminOrigin(host)}/reserve-desk`, label: "Reserve Desk" } : null,
