...
export default async function VenueDashboardPage() {
  await requirePlatformRole("/venue/dashboard", ["venue"]);
  ...
  return (
    <SurfaceShell
      ...
      description="Venue operators get a purpose-built dashboard for scanner access, attendance pulse, and event-day execution."
      meta={
        <>
          ...
          <div className="ev-meta-card">
            ...
            <div className="ev-meta-value">Scanner launch and check-in visibility stay separated from public attendee flows.</div>
          </div>
        </>
      }
    >
